	...
	public function internal_hardware_device($hardwarename) {
		...
		if($hardwarename == 'cpu_cooler') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630847/images/internal_hardwares/cpu_cooler_hpg6ep.webp',
		...
		if($hardwarename == 'cpu') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630847/images/internal_hardwares/cpu_ekqfja.webp',
		...
		if($hardwarename == 'fan') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630847/images/internal_hardwares/fan_exrffz.webp',
		...
		if($hardwarename == 'gpu') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/gpu_e2nogq.webp',
		...
		if($hardwarename == 'hard_drive') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630847/images/internal_hardwares/hard_drive_vlkl3q.webp',
		...
		if($hardwarename == 'motherboard') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/motherboard_bmhdbe.webp',
		...
		if($hardwarename == 'nic') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630847/images/internal_hardwares/nic_wi4sjf.webp',
		...
		if($hardwarename == 'power_supply') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/power_supply_rdklno.webp',
		...
		if($hardwarename == 'ram') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/ram_doj669.webp',
		...
		if($hardwarename == 'sound_card') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/sound_card_lqtqmt.webp',
		...
		if($hardwarename == 'ssd') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630848/images/internal_hardwares/ssd_rqi4d1.webp',
	...
	public function external_hardware_device($hardwarename) {
		...
		if($hardwarename == 'digital_camera') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/digital_camera.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630868/images/external_hardwares/digital_camera_vh5qfx.webp',
		...
		if($hardwarename == 'external_hard_drive') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/external_hard_drive.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/external_hard_drive.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630868/images/external_hardwares/external_hard_drive_yk9kk4.webp',
		...
		if($hardwarename == 'joystick') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/joystick.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/joystick_sdwpai.webp',
		...
		if($hardwarename == 'keyboard') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/keyboard.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/keyboard_kie6ue.webp',
		...
		if($hardwarename == 'mic') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/mic.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/mic.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/mic_oef328.webp',
		...
		if($hardwarename == 'monitor_lcd') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/monitor_lcd.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/monitor_lcd.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/monitor_lcd_dqmtwd.webp',
		...
		if($hardwarename == 'monitor_crt') {
			return view('hardware', ['hardware_info' => [
				...
				'hardware_description' => "An electrical visual computer display known as a monitor consists of a screen, circuitry, and the housing for that equipment. Cathode ray tubes (CRT) were used in older computer monitors, which made them bulky, heavy, and ineffective. Since they are lighter and more energy-efficient, flat-screen LCD displays are now found in gadgets like laptops, PDAs, and desktop PCs. Another name for a monitor is a screen or a visual display device (VDU).",
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630868/images/external_hardwares/monitor_crt_yctclk.webp',
				'hardware_video' => 'https://www.youtube.com/embed/LaqeGAXkIsE',
				'hardware_ref_text' => 'https://www.techopedia.com/definition/3185/monitor#:~:text=Techopedia%20Explains%20Monitor-,What%20Does%20Monitor%20Mean%3F,them%20large%2C%20heavy%20and%20inefficient.',
		...
		if($hardwarename == 'mouse') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/mouse.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/mouse.usdz', 
				'hardware_name' => 'Mouse', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/mouse_eokbwr.webp',
		...
		if($hardwarename == 'plotter') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/plotter.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/plotter.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/plotter_onjadx.webp',
		...
		if($hardwarename == 'printer') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/printer.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/printer.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/printer_hamiei.webp',
		...
		if($hardwarename == 'projector') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/projector.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/projector.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/projector_bbaror.webp',
		...
		if($hardwarename == 'sd_card') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/sd_card.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/sd_card.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630869/images/external_hardwares/sd_card_j42m2m.webp',
		...
		if($hardwarename == 'speaker') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/speaker.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/speaker.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630870/images/external_hardwares/speaker_d7ttsh.webp',
		...
		if($hardwarename == 'trackball') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/trackball.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/trackball.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630870/images/external_hardwares/trackball_juipqz.webp',
		...
		if($hardwarename == 'usb_card_reader') {
			return view('hardware', ['hardware_info' => [
				'hardware_url_android' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/usb_card_reader.glb', 
				'hardware_url_ios' => 'https://cdn.jsdelivr.net/gh/GabrielSalangsang013/team-cord-web-ar@latest/public/models/external_hardwares/usb_card_reader.usdz', 
				...
				'hardware_image' => 'https://res.cloudinary.com/dr9p65xlj/image/upload/c_scale,q_80,w_300/v1667630870/images/external_hardwares/usb_card_reader_d8klfj.webp',
